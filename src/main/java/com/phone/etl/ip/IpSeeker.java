...
public class IpSeeker {
    ...
    protected IpSeeker() {
        ...
        b3 = new byte[3];
        try {
            String ipFilePath = IpSeeker.class.getClassLoader().getResource("qqwry.dat").getPath();
//            logger.info(getClass().getProtectionDomain().getCodeSource().getLocation().getPath());
//            ipFile = new RandomAccessFile("/qqwry.dat", "r");
            File tmpFile = new File("./tmpqqwry");
            inputStreamToFile(IpSeeker.class.getResourceAsStream("/qqwry.dat"),tmpFile);
//            ipFile = new RandomAccessFile(ipFilePath, "r");
            ipFile = new RandomAccessFile(tmpFile, "r");
